...
--
-- Definition of table `salse_details`
--

DROP TABLE IF EXISTS `salse_details`;
CREATE TABLE `salse_details` (
  `salse_id` int(10) unsigned NOT NULL auto_increment,
...
/*!40000 ALTER TABLE `salse_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `salse_details` ENABLE KEYS */;
