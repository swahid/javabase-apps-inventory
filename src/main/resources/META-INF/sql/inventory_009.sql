...
INSERT INTO `user` (`user_id`,`user_name`,`first_name`,`last_name`,`contact`,`role_id`,`password`,`status`) VALUES 
 (1,'saurav','Saurav','Wahid','01713792428',1,'123','ACTIVE'),
 (2,'demo','demo','demo','demo',5,'demo','ACTIVE'),
 (3,'admin','admin','admin',NULL,5,'123','ACTIVE'),
 (4,'test','test','test',NULL,5,'test','ACTIVE');
